        ...
        <div class="wrapper">
            <div class="main p-3">
                <div class="text-center mb-4">
                    <h1>Test para medir estrés.</h1>
                </div>
                <div class="d-flex justify-content-center">
                    <div class="wrapper-test">
                        <div class="quiz-container">
                            <div class="quiz-head">
                                <h1 class="quiz-title">Test SISCO</h1>
                                <%
                                ...
                                %>
                                <div class="quiz-score flex mb-4">
                                    <span class="fw-bold"><%= indicePregunta + 1%>/<span id="total-question"><%= listaPreguntas.size()%></span></span>
                                </div>
                            </div>
                            <div class="quiz-body">
                                <div class="container-juego" id="container-juego">
                                    <div class="info">
                                        <div class="pregunta mb-4">
                                            <h6 class="text-capitalize"><%= preguntaActual.getPregunta()%></h6>
                                        </div>
